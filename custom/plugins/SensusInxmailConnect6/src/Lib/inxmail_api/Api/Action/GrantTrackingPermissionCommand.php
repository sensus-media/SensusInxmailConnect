 ...
 */
/**
 * Use the <i>Inx_Api_Action_GrantTrackingPermissionCommand</i> to grant tracking permission to a standard list.
 *
 * @see Inx_Api_Action_CommandFactory
 * @since API 1.16.0
 */
interface Inx_Api_Action_GrantTrackingPermissionCommand extends Inx_Api_Action_Command
{
	/**
