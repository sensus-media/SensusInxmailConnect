...
class Inx_Apiimpl_Action_CommandImpl_RevokeTrackingPermissionCmd
    extends Inx_Apiimpl_Action_CommandImpl
    implements Inx_Api_Action_RevokeTrackingPermissionCommand
{
	public function __construct( $mFirstParam )
	{
        ...
        $this->_oCommandData->type = self::REVOKE_TRACKING_PERMISSION_CMD_TYPE;
    ...
    {
        return "RevokeTrackingPermissionCommand - listContextId: " . $this->getInteger( self::ONE );
    }
